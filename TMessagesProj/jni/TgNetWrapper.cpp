...
static const char *FileLoadOperationClassPathName = "org/telegram/digitalresistance/tgnet/FileLoadOperation";
...
static const char *NativeByteBufferClassPathName = "org/telegram/digitalresistance/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "org/telegram/digitalresistance/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(ILorg/telegram/digitalresistance/tgnet/RequestDelegateInternal;Lorg/telegram/digitalresistance/tgnet/QuickAckDelegate;Lorg/telegram/digitalresistance/tgnet/WriteToSocketDelegate;IIIZI)V", (void *) sendRequest},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("org/telegram/digitalresistance/tgnet/RequestDelegateInternal"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/telegram/digitalresistance/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_WriteToSocketDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/telegram/digitalresistance/tgnet/WriteToSocketDelegate"));
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/telegram/digitalresistance/tgnet/FileLoadOperationDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("org/telegram/digitalresistance/tgnet/ConnectionsManager"));
