...
import org.telegram.digitalresistance.messenger.LocationController;
...
import org.telegram.digitalresistance.messenger.camera.CameraController;
...
import org.telegram.digitalresistance.ui.ActionBar.DrawerLayoutContainer;
import org.telegram.digitalresistance.ui.ActionBar.Theme;
import org.telegram.digitalresistance.ui.Adapters.DrawerLayoutAdapter;
import org.telegram.digitalresistance.ui.Cells.LanguageCell;
import org.telegram.digitalresistance.ui.Components.AlertsCreator;
import org.telegram.digitalresistance.ui.Components.AudioPlayerAlert;
...
import org.telegram.digitalresistance.ui.Components.PasscodeView;
...
import org.telegram.digitalresistance.ui.Components.SharingLocationsAlert;
import org.telegram.digitalresistance.ui.Components.StickersAlert;
import org.telegram.digitalresistance.ui.Components.ThemeEditorView;
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || UserConfig.isWaitingForPasscodeEnter)) {
            ...
            if (UserConfig.isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                    ...
                    } else if (intent.getAction().equals("org.telegram.digitalresistance.messenger.OPEN_ACCOUNT")) {
                        open_settings = 1;
