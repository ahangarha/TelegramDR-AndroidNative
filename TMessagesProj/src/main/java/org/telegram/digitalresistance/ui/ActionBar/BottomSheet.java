...
public class BottomSheet extends Dialog {
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        public BottomSheetCell(Context context, int type) {
            ...
            setBackgroundDrawable(org.telegram.digitalresistance.ui.ActionBar.Theme.getSelectorDrawable(false));
            setPadding(AndroidUtilities.dp(16), 0, AndroidUtilities.dp(16), 0);

            imageView = new ImageView(context);
            imageView.setScaleType(ImageView.ScaleType.CENTER);
            imageView.setColorFilter(new PorterDuffColorFilter(org.telegram.digitalresistance.ui.ActionBar.Theme.getColor(org.telegram.digitalresistance.ui.ActionBar.Theme.key_dialogIcon), PorterDuff.Mode.MULTIPLY));
            ...
            if (type == 0) {
                textView.setTextColor(org.telegram.digitalresistance.ui.ActionBar.Theme.getColor(org.telegram.digitalresistance.ui.ActionBar.Theme.key_dialogTextBlack));
    ...
    public BottomSheet(Context context, boolean needFocus) {
        ...
        shadowDrawable.setColorFilter(new PorterDuffColorFilter(org.telegram.digitalresistance.ui.ActionBar.Theme.getColor(org.telegram.digitalresistance.ui.ActionBar.Theme.key_dialogBackground), PorterDuff.Mode.MULTIPLY));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (title != null) {
            ...
            titleView.setTextColor(org.telegram.digitalresistance.ui.ActionBar.Theme.getColor(org.telegram.digitalresistance.ui.ActionBar.Theme.key_dialogTextGray2));
