...
package org.telegram.digitalresistance.messenger.camera;
...
public class CameraView extends FrameLayout implements TextureView.SurfaceTextureListener {
    ...
    private void initCamera(boolean front) {
        ...
        org.telegram.digitalresistance.messenger.camera.Size aspectRatio;
        int wantedWidth;
        int wantedHeight;
        if (initialFrontface) {
        ...
        org.telegram.digitalresistance.messenger.camera.Size pictureSize = CameraController.chooseOptimalSize(info.getPictureSizes(), wantedWidth, wantedHeight, aspectRatio);
        if (pictureSize.getWidth() >= 1280 && pictureSize.getHeight() >= 1280) {
            ...
            org.telegram.digitalresistance.messenger.camera.Size pictureSize2 = CameraController.chooseOptimalSize(info.getPictureSizes(), wantedHeight, wantedWidth, aspectRatio);
