...
import org.telegram.digitalresistance.messenger.StatsController;
import org.telegram.digitalresistance.messenger.UserConfig;
import org.telegram.digitalresistance.messenger.Utilities;
import org.telegram.digitalresistance.psiphon.PsiphonConnection;
...
public class ConnectionsManager {
    ...
    private PsiphonConnection psiphonConnection;
    ...
    public ConnectionsManager() {
        ...
        initPsiphon(deviceModel, systemVersion, appVersion, langCode, systemLangCode, configPath, enablePushConnection);
        try {
    ...
    private void initPsiphon(final String deviceModel, final String systemVersion, final String appVersion, final String langCode, final String systemLangCode, final String configPath, final boolean enablePushConnection) {
        Log.d("Psiphon", "Initiating Psiphon...");

        psiphonConnection = new PsiphonConnection(ApplicationLoader.applicationContext);
        psiphonConnection.connect(new PsiphonConnection.ConnectionListener() {
            @Override
            public void onPsiphonConnected(int port) {
                Log.d("Psiphon", "Connected to Psiphon");
                init(BuildVars.BUILD_VERSION, TLRPC.LAYER, BuildVars.APP_ID, deviceModel, systemVersion, appVersion, langCode, systemLangCode, configPath, FileLog.getNetworkLogPath(), UserConfig.getClientUserId(), enablePushConnection, port);
            }

            @Override
            public void onPsiphonError(Exception error) {
                Log.e("Psiphon", "Psiphon connection error. " + error.getMessage());
            }
        });
    }

    public void init(int version, int layer, int apiId, String deviceModel, String systemVersion, String appVersion, String langCode, String systemLangCode, String configPath, String logPath, int userId, boolean enablePushConnection, int port) {
        SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", Activity.MODE_PRIVATE);
        String proxyAddress = preferences.getString("proxy_ip", "");
        String proxyUsername = preferences.getString("proxy_user", "");
        String proxyPassword = preferences.getString("proxy_pass", "");

        native_setProxySettings(proxyAddress, port, proxyUsername, proxyPassword);
